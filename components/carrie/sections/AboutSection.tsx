...
export default function AboutSection({ showAddress, onToggleAddress }: AboutSectionProps) {
  return (
      ...
      <div>
        <div>
          ...
          <div className="bg-slate-800 text-white border-8 border-slate-700 p-10">
            ...
            <h3 className="text-3xl font-black text-white mb-6 tracking-wide md:hidden text-center">THE ARTIST</h3>
            ...
            <div className="flex flex-col md:flex-row items-center gap-10">
              ...
              <div>
                {/* Desktop: Title in normal position */}
                <h3 className="text-3xl font-black text-white mb-6 tracking-wide hidden md:block">THE ARTIST</h3>
